...
Project organisation: `here`

Retrieving text data: `gutenbergr`

Tidying text data: `tidytext`, `dplyr`, `stringr`, `tidyr`

Creating graph data (for network analysis): `igraph`

Plotting: `ggplot2`, `ggraph`
...
## Example 2: Network analysis in Australian football
...
## Example 3: Scoring dynamics in Australian football
